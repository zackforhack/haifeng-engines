...
const TMP_DIR = path.join(os.tmpdir(), 'cummins-official-hsk78g-data-sheets-2026-08')
...
const records = [
  {
    slug: 'cummins-c1600n6cd',
    model: 'C1600N6CD',
    sourceUrl: 'https://www.cummins.com/sites/default/files/2019-12/D-6417f_Marketing.pdf',
    storagePath: 'cummins/gas/official-hsk78g-data-sheets/c1600n6cd-d-6417f.pdf',
    label: 'Cummins C1600N6CD Generator Set Data Sheet',
    requiredTokens: ['C1600N6CD', 'HSK78G', 'Cummins', 'Generator Set Data Sheet', 'D-6417'],
  },
  {
    slug: 'cummins-c1800n6cd',
    model: 'C1800N6CD',
    sourceUrl: 'https://www.cummins.com/sites/default/files/2019-12/D-6413f_Marketing.pdf',
    storagePath: 'cummins/gas/official-hsk78g-data-sheets/c1800n6cd-d-6413f.pdf',
    label: 'Cummins C1800N6CD Generator Set Data Sheet',
    requiredTokens: ['C1800N6CD', 'HSK78G', 'Cummins', 'Generator Set Data Sheet', 'D-6413'],
  },
  {
    slug: 'cummins-c2000n6cd',
    model: 'C2000N6CD',
    sourceUrl: 'https://www.cummins.com/sites/default/files/2019-12/D-6409f_Marketing.pdf',
    storagePath: 'cummins/gas/official-hsk78g-data-sheets/c2000n6cd-d-6409f.pdf',
    label: 'Cummins C2000N6CD Generator Set Data Sheet',
    requiredTokens: ['C2000N6CD', 'HSK78G', 'Cummins', 'Generator Set Data Sheet', 'D-6409'],
  },
]
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: ${records.length} Cummins official HSK78G data sheets`)
