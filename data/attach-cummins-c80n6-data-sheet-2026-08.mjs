...
const TMP_DIR = path.join(os.tmpdir(), 'cummins-c80n6-data-sheet-2026-08')
const RECORD = {
  slug: 'cummins-c80n6',
  model: 'C80N6',
  sourcePage:
  ...
  storagePath: 'cummins/gas/exact-spec-sheets/c80n6-data-sheet.pdf',
  label: 'Cummins C80N6 Generator Set Data Sheet',
  requiredTokens: ['C80N6', 'Cummins', 'Generator set data sheet', 'NAD-6097'],
  rejectTokens: [
    'C20N6',
    'C25N6',
    'C30N6',
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: Cummins C80N6 exact data sheet`)
