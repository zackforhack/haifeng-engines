...
const lp='/tmp/cat/lehw0029.pdf'
const model='G3406', storage='caterpillar/g3406-gas-datasheet.pdf', label='Cat G3406 Gas Petroleum Engine Spec Sheet'
...
if(t.indexOf('G3406')<0){console.error('model not in PDF');process.exit(1)}
