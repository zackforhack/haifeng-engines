...
const CROSS_LINKS = [
  {
    storagePath: 'yanmar/4tnv98c-gge.pdf',
    keepSlug: 'yanmar-4tnv98c-gge',
    removeSlugs: [
      'yanmar-4tnv98c-iye',
      'yanmar-4tnv98ct-gge',
      'yanmar-4tnv98ct-iye',
  ...
  {
    storagePath: 'yanmar/3tnv88-gge.pdf',
    keepSlug: 'yanmar-3tnv88-gge',
    removeSlugs: ['yanmar-3tnv88-gghwc'],
  },
]
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: prune Yanmar exact PDFs from sibling variants`)
...
console.log(`Deleted ${removals.length} incorrect Yanmar sibling link rows.`)
