...
const lp='/tmp/cat/lehw0042.pdf'
const model='G3616', storage='caterpillar/g3616-gas-datasheet.pdf', label='Cat G3616 Gas Petroleum Engine Spec Sheet'
...
if(t.indexOf('G3616')<0){console.error('model not in PDF');process.exit(1)}
