// Attach source-validated RealDiesels Lister CS4/CS6 technical-data rows.
//
// Dry run:
//   node data/attach-lister-cs4-cs6-realdiesels-strict-data-batch-76-2026-08.mjs
// Apply:
//   node data/attach-lister-cs4-cs6-realdiesels-strict-data-batch-76-2026-08.mjs --apply
...
const REPORT_PATH =
  'reports/legacy-engine-doc-attachments-2026-08-12-batch-76-lister-cs4-cs6-realdiesels-strict-data.md'
const SOURCE_URL = 'https://realdiesels.co.uk/listerdata.html'
const USER_AGENT =
  'Mozilla/5.0 (compatible; HaifengListerCS46RealDieselsStrictData/1.0; +https://engines.haifengmachinery.com)'

const TARGETS = [
  { slug: 'lister-petter-lister-petter-cs4', token: 'CS4' },
  { slug: 'lister-petter-lister-petter-cs6', token: 'CS6' },
]
...
function buildReport({ pageBytes, linkedCount, skippedCount, missingEngines, coverageBefore, coverageAfter }) {
  return `# Legacy Engine Document Attachments - Batch 76 Lister CS4/CS6 RealDiesels Strict Data
...
- The RealDiesels page includes exact technical-data table rows for CS4 and CS6 with cylinders, capacity, bore/stroke, HP/RPM, cooling, weight, fuel and combustion/injection fields.
- Petter AA1M remains unlinked because the current source check found AA1M only in page metadata, not in the model technical-data table body.
`
}
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: Lister CS4/CS6 RealDiesels strict data links`)
