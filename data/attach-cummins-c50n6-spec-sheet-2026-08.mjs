...
const TMP_DIR = path.join(os.tmpdir(), 'cummins-c50n6-spec-sheet-2026-08')
const RECORD = {
  slug: 'cummins-c50n6',
  model: 'C50N6',
  sourcePage:
  ...
  storagePath: 'cummins/gas/exact-spec-sheets/c50n6-spec-sheet.pdf',
  label: 'Cummins C50N6 Specification Sheet',
  requiredTokens: ['C50N6', 'Cummins', 'Specification Sheet', 'NAS-6168-EN'],
  rejectTokens: [
    'C20N6',
    'C25N6',
    'C30N6',
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: Cummins C50N6 exact spec sheet`)
