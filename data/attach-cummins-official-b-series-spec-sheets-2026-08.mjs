...
const TMP_DIR = path.join(os.tmpdir(), 'cummins-official-b-series-spec-sheets-2026-08')
...
const records = [
  {
    slug: 'cummins-4btaa33g17',
    model: '4BTAA3.3-G17',
    sourcePage:
      'https://www.cummins.com/en-na/g-drive-engines/products/diesel-mechanical-b-series',
    sourceUrl: 'https://mart.cummins.com/imagelibrary/data/assetfiles/0064177.pdf',
    storagePath: 'cummins/official-b-series-spec-sheets/4btaa33-g17.pdf',
    label: 'Cummins 4BTAA3.3-G17 Official B-Series Specification Sheet',
    rejectTokens: [
      '4BTAA3.3-G12',
      '4BTAA3.3-G13',
      '4BTAA3.3-G14',
  ...
  {
    slug: 'cummins-4btaa33g18',
    model: '4BTAA3.3-G18',
    sourcePage:
      'https://www.cummins.com/en-na/g-drive-engines/products/diesel-mechanical-b-series',
    sourceUrl: 'https://mart.cummins.com/imagelibrary/data/assetfiles/0064178.pdf',
    storagePath: 'cummins/official-b-series-spec-sheets/4btaa33-g18.pdf',
    label: 'Cummins 4BTAA3.3-G18 Official B-Series Specification Sheet',
    rejectTokens: [
      '4BTAA3.3-G12',
      '4BTAA3.3-G13',
      '4BTAA3.3-G14',
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: ${records.length} Cummins official B-Series spec sheets`)
