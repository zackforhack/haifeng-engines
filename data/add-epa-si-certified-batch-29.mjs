// Add EPA-certified Cummins 550-750 kWe 60 Hz natural-gas packages.
...
const records = [
  {
    ...
    standby_power_kwe_60hz: 550,
    standby_power_kva_60hz: 688,
    prime_power_kwe_60hz: null,
    prime_power_kva_60hz: null,
    _demandResponseKwe: 500,
  },
  {
    ...common,
    slug: 'cummins-c600n6',
    model: 'C600N6',
    series: 'GTA50E Genset',
    certifications: [
      'U.S. EPA Stationary',
      'U.S. EPA Stationary Non-Emergency',
      'U.S. EPA NSPS',
    ...
    cylinders: 16,
    displacement_l: 50.3,
    configuration: 'V16 Stoichiometric Turbocharged Aftercooled',
    standby_power_kwe_60hz: 600,
    standby_power_kva_60hz: 750,
    prime_power_kwe_60hz: null,
    prime_power_kva_60hz: null,
  },
  ...[
    ['C650N6', 650, 813, 600],
    ['C750N6', 750, 938, 700],
  ].map(([model, standbyKwe, standbyKva, demandKwe]) => ({
    ...common,
    ...
    prime_power_kwe_60hz: null,
    prime_power_kva_60hz: null,
    _demandResponseKwe: demandKwe,
  })),
].map(({ _demandResponseKwe, ...record }) => ({
  ...record,
  description:
    ...
    + `and EPA stationary compliance${_demandResponseKwe
      ? `, with a separate ${_demandResponseKwe} kWe demand-response rating`
      : ''}.`,
}))
