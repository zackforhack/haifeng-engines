...
const lp='/tmp/cat/c66.pdf'
const model='C6.6', storage='caterpillar/c6-6-diesel-genset-datasheet.pdf', label='Cat C6.6 Diesel Generator Set Spec Sheet'
...
if(t.replace(/[^A-Za-z0-9.]/g,'').indexOf('C6.6')<0){console.error('model not in PDF');process.exit(1)}
