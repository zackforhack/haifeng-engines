...
const lp='/Users/ziqianhuang/Downloads/LEHW0026-00.pdf'
const model='G3306', storage='caterpillar/g3306-gas-datasheet.pdf', label='Cat G3306 Gas Petroleum Engine Spec Sheet'
...
if(t.indexOf('G3306')<0){console.error('model not in PDF');process.exit(1)}
