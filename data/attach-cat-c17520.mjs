...
const lp='/Users/ziqianhuang/Downloads/SS-9578917-18503929-078.pdf'
const model='C175-20', storage='caterpillar/c175-20-diesel-genset-datasheet.pdf', label='Cat C175-20 Diesel Generator Set Spec Sheet'
...
if(t.replace(/[^A-Za-z0-9-]/g,'').indexOf('C175-20')<0){console.error('model not in PDF');process.exit(1)}
