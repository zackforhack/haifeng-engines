...
const TMP_DIR = path.join(os.tmpdir(), 'rehlko-official-kd-engine-info-sheets-2026-08')
...
const records = [
  {
    slug: 'kohler-kd27v12',
    model: 'KD27V12',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/kd_series_data_kd27v12.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd27v12.pdf',
    label: 'Rehlko/Kohler KD27V12 Engine Info Sheet',
  },
  {
    slug: 'kohler-kd36v16',
    model: 'KD36V16',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/kd_series_data_kd36v16.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd36v16.pdf',
    label: 'Rehlko/Kohler KD36V16 Engine Info Sheet',
  },
  {
    slug: 'kohler-kd45v20',
    model: 'KD45V20',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/kd_series_data_kd45v20.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd45v20.pdf',
    label: 'Rehlko/Kohler KD45V20 Engine Info Sheet',
  },
  {
    slug: 'kohler-kd83v16',
    model: 'KD83V16',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/kd_series_data_kd83v16.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd83v16.pdf',
    label: 'Rehlko/Kohler KD83V16 Engine Info Sheet',
  },
  {
    slug: 'kohler-kd62v12',
    model: 'KD62V12',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/kd_series_data_kd62v12.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd62v12.pdf',
    label: 'Rehlko/Kohler KD62V12 Engine Info Sheet',
  },
  {
    slug: 'kohler-kd103v20',
    model: 'KD103V20',
    sourceUrl: 'https://resources.rehlko.com/industrial/pdf/KD_Series_Sellsheet.pdf',
    storagePath: 'kohler/rehlko-official-kd-engine-info-sheets/kd103v20.pdf',
    label: 'Rehlko/Kohler KD103V20 Engine Info Sheet',
  },
]
...
function assertStillMissingExclusive() {
  ...
  const missingSlugs = new Set((report.groups?.Kohler ?? []).map((row) => row.slug))
...
function verifyPdf(record, localPath) {
  ...
  const requiredTokens = [record.model, 'Kohler', 'KD Series', 'Engine']
  ...
  const siblingHits = kdSiblingTokens.filter(
    (token) => token !== record.model && normalizedText.includes(normalize(token)),
  )
...
console.log(
  `${APPLY ? 'APPLY' : 'DRY RUN'}: ${records.length} Rehlko/Kohler KD engine info sheets`,
)
...
for (const record of records) {
  ...
  if (engine.brand !== 'Kohler' || normalize(engine.model) !== normalize(record.model)) {
