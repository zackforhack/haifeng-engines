...
const lp='/tmp/cat/cm.pdf'
const model='C3.3', storage='caterpillar/c3-3-diesel-genset-datasheet.pdf', label='Cat C3.3 Diesel Generator Set Spec Sheet'
...
if(t.replace(/[^A-Za-z0-9.]/g,'').indexOf('C3.3')<0){console.error('model not in PDF');process.exit(1)}
