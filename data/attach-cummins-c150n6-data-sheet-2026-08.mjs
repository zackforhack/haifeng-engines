...
const TMP_DIR = path.join(os.tmpdir(), 'cummins-c150n6-data-sheet-2026-08')
const RECORD = {
  slug: 'cummins-c150n6',
  model: 'C150N6',
  sourcePage:
  ...
  storagePath: 'cummins/gas/exact-spec-sheets/c150n6-data-sheet.pdf',
  label: 'Cummins C150N6 Generator Set Data Sheet',
  requiredTokens: ['C150N6', 'Cummins', 'Generator Set Data Sheet', 'NAS-6304'],
  rejectTokens: [
    'C20N6',
    'C25N6',
    'C30N6',
...
console.log(`${APPLY ? 'APPLY' : 'DRY RUN'}: Cummins C150N6 exact data sheet`)
