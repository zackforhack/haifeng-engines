...
**Why 208 V and not 240 V?** Unlike Europe's 230/400V system, the North American Wye is built from three transformer windings each supplying 120 V. Measure between any two phases and the vectors add to **208 V** — not the 240 V you get from a residential split-phase service. One distribution system then serves both:
...
| 120/240 V | Delta or split-phase |
